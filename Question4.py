...
#Prints the first index that is greater than or equal to the key value
if indices_where_random_value_is_greater_than_or_equal_to_random_key_value:
    print(f"First matching index: {indices_where_random_value_is_greater_than_or_equal_to_random_key_value[0]}")
